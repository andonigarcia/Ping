...
function mttIndiv(id){
    ...
    var bio = {"andoni":"What's up guys. I'm the resident Commander in Chief over here at <span class='lilLogo'>Ping!</span>. I guess it comes with the territory, but I'm also the mastermind behind our tech. I'm the dude that looks responsibilities in the eye and tackles it at the first get-go. <span class='lilLogo'>Ping!</span> is my baby and I'm watching it grow at phenomenal rates.<p>When I'm not being swamped with classes, working one of my million jobs, or pulling all nighters working on <span class='lilLogo'>Ping!</span>, I can be found kickin it table side in Chicago's nightlife scene. Everyone needs to unwind somehow. I generally like a nice movie and a bottle of wine, but sometimes the good times need to roll on.</p><p><a href='http://andonigarcia.com/'>Andoni M. Garcia</a><br /><a href='mailto:andoni@uchicago.edu'>andoni@uchicago.edu</a><br />760-845-8667</p>",
